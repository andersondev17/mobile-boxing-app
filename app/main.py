...
async def lifespan(app: FastAPI):
    ...
    # Seeding with Postgres Session
    from app.config.database import _AsyncSessionLocal
    if _AsyncSessionLocal:
        ...
        logger.warning("⚠️ Skipping seed: Postgres not initialized.")
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "exp://127.0.0.1:8081",  # Expo Go iOS Simulator
    ],
