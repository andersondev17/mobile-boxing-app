...
# Core landmarks required for elbow extension and punch detection
...
# Auxiliary landmarks that enhance analysis but aren't strictly required for punch detection
AUX_LANDMARK_INDICES: frozenset[int] = frozenset({
    23, 24,  # hips
})
